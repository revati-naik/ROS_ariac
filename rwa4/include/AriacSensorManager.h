...
public:
    ...
    void lc_bin1_callback(const osrf_gear::LogicalCameraImage::ConstPtr &);
    void lc_bin2_callback(const osrf_gear::LogicalCameraImage::ConstPtr &);
    void lc_bin3_callback(const osrf_gear::LogicalCameraImage::ConstPtr &);
    void lc_bin4_callback(const osrf_gear::LogicalCameraImage::ConstPtr &);
    void lc_bin5_callback(const osrf_gear::LogicalCameraImage::ConstPtr &);
    void lc_bin6_callback(const osrf_gear::LogicalCameraImage::ConstPtr &);
